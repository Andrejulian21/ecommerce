  ...
  <div class="container-fluid px-4">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="nav-link px-3 nav-link-custom" href="{{ url('/products') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-grid me-1" viewBox="0 0 16 16">
        ...
        <li class="nav-item">
          <a class="nav-link px-3 nav-link-custom btn-create" href="{{ url('/products/create') }}">
